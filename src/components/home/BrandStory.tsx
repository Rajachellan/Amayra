          ...
          <div className="flex flex-col md:flex-row items-start justify-center gap-12 md:gap-24 text-left">
            <div className="flex-1 space-y-8">
              <p className="text-foreground/70 text-base md:text-lg font-light leading-relaxed font-serif-alt">
                For over three decades, Gems of Shree Aarna has been a custodian of India&apos;s rich jewelry heritage. What began as a small boutique of handcrafted wonders has evolved into a hallmark of luxury, trusted by families across generations.
              </p>
            </div>
            <div className="flex-1 space-y-8">
              <p className="text-foreground/70 text-base md:text-lg font-light leading-relaxed font-serif-alt">
