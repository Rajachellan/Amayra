          ...
          {occasions.map((occ, idx) => (
            ...
            >
              <Link href={occ.href} className="flex flex-col items-center">
                ...
                <h4 className="text-brand-emerald font-serif text-xl md:text-2xl group-hover:text-brand-gold transition-colors duration-300">
                  {occ.name}
                </h4>
                <span className="text-xs tracking-[0.3em] font-bold text-gray-400 mt-2 uppercase group-hover:text-brand-emerald transition-colors">
                  EXPLORE COLLECTIONS
                </span>
              </Link>
            </motion.div>
